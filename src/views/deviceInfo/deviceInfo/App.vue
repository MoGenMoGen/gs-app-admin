  ...
  <div id="container">
    ...
    >
      ...
      >
        ...
        <div style="margin-left: 10px; padding-bottom: 10px">
          <span style="width: 180rpx; display: inline-block">设备编号：</span
          >{{ item.no }}
        </div>
    ...
    >
      <van-cell-group style="margin-top: 50px">
        ...
        ></van-field>
        <van-field
          v-model="info.technicalParameter"
          label="技术参数:"
          readonly
          label-width="120"
        ></van-field>
        <van-field
          v-model="info.devicePower"
          label="设备功率:"
          readonly
          label-width="120"
        ></van-field>
        <van-field
          v-model="info.manufacturingUnit"
          label="制造单位:"
          readonly
          label-width="120"
        ></van-field>
        <van-field
          v-model="info.deliveryUnit"
          label="供货单位:"
          readonly
          label-width="120"
        ></van-field>
        <van-field
          v-model="info.specialParameter"
          label="专用参数:"
          readonly
          label-width="120"
        ></van-field>
