        ...
        methods: {
            ...
            bindEvent () {
                ...
                this.canvas.addEventListener('touchstart', (e) => {
                    ...
                    this.writeBegin({ x: touch.pageX || touch.clientX, y: touch.clientY - this.h || touch.clientY - this.h});
                });
                ...
                this.canvas.addEventListener('touchmove', (e) => {
                    e && e.preventDefault() && e.stopPropagation();
                    const touch = e.targetTouches[0];
                    this.config.isWrite && this.writing({ x: touch.pageX, y: touch.clientY - this.h});
                });
                ...
                this.canvas.addEventListener('touchend', (e) => {
                    ...
                    this.writeEnd({ x: touch.pageX, y: touch.clientY-this.h });
                });
                /* ==========================移动端兼容=End================================ */
            },
