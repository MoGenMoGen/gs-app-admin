<template>
    <div id="container">
        ...
        <van-cell-group>
            ...
            <van-field v-model="info.agreedContent"  label="其他需要约定内容：" placeholder="请输入内容"   rows="3" type="textarea" label-width="120" clearable>  </van-field>
            ...
            <van-field v-model="info.discloseUserPhone"  label="联系电话：" placeholder="请输入联系电话"  label-width="120" clearable>  </van-field>
            <van-field readonly clickable name="datetimePicker"  :value="info.discloseUserTm"  label="签字时间"  placeholder="点击选择时间" @click="showPicker = true" label-width="120"></van-field>
            ...
            <van-field v-model="info.coverUserPhone"  label="联系电话：" placeholder="请输入联系电话"  label-width="120" clearable>  </van-field>
            <van-field readonly clickable name="datetimePicker"  :value="info.coverUserTm"  label="签字时间"  placeholder="点击选择时间" @click="showPicker2 = true" label-width="120"></van-field>
            <van-popup v-model="showPicker2" position="bottom">
                <van-datetime-picker  v-model="currentDate" type="datetime"  @confirm="onConfirm2"   @cancel="showPicker2 = false"></van-datetime-picker>
            </van-popup>
