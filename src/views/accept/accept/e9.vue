<template>
    <div id="container">
        ...
        <van-form>
            ...
            <van-field v-model="info.communityPhone" label="社区电话："  label-width="80"  placeholder="请输入社区电话" clearable></van-field>
            <van-field v-model="info.propertyPhone" label="物业电话："  label-width="80"  placeholder="请输入物业电话" clearable></van-field>
            ...
            <van-field v-model="info.pumpLocation" label="泵房位置：" rows="2" type="textarea" label-width="80"  placeholder="请输入泵房位置" clearable></van-field>
            ...
            <van-field readonly clickable  :value="info.equipmentNm" label="设备供应商:"  placeholder="点击选择设备供应商"  @click="showPicker2 = true"></van-field>
            <van-field v-model="info.equipmentPhone" label="联系人及电话："  label-width="100"  placeholder="请输入联系人及电话" clearable></van-field>
            <van-field readonly clickable name="date"  :value="info.transferTm"  label="移交时间："  placeholder="点击选择时间" @click="dateShow(1)" label-width="100" right-icon="calender-o"></van-field>
            <van-field readonly clickable name="date"  :value="info.warrantyTm"  label="质保时间："  placeholder="点击选择时间" @click="dateShow(2)" label-width="100" right-icon="calender-o"></van-field>
...
<!--            </van-field>-->
            ...
            <van-field v-model="info.partitionFloor" label="分区楼层："  label-width="80"  placeholder="请输入分区楼层" clearable></van-field>
            ...
            <van-field v-model="info.val21" label="二次供水分公司验收人员："  label-width="150"  placeholder="请输入验收人员" clearable></van-field>
            ...
            <van-field readonly clickable name="date"  :value="info.val24"  label="初验日期："  placeholder="点击选择时间" @click="dateShow(3)" label-width="100" right-icon="calender-o"></van-field>
            <van-field readonly clickable name="date"  :value="info.val25"  label="复验日期："  placeholder="点击选择时间" @click="dateShow(4)" label-width="100" right-icon="calender-o"></van-field>
            ...
            <van-field  v-model="info.val29"  rows="2" autosize label="建设单位整改内容：" type="textarea"  placeholder="请输入" label-width="120" ></van-field>
            <van-field v-model="info.val30" label="设备厂家：" label-width="80" readonly></van-field>
            <van-field  v-model="info.val31"  rows="2" autosize label="设备厂家整改内容：" type="textarea"  placeholder="请输入" label-width="120" ></van-field>
            ...
            <van-field readonly clickable name="date"  :value="info.val35"  label="签字时间："  placeholder="点击选择时间" @click="dateShow(5)" label-width="80"></van-field>
            ...
            getInfo(id) {
                ...
                this.api.getE9(encodeURIComponent(this.query.toJsonStr(qry))).then(res => {
                    if (res.code === 200) {
                        ...
                        // this.query.toW(qry2, 'earlyId', id, "EQ");
