<template>
    <div id="container">
        <van-nav-bar fixed title="能耗管理" @click-left="back" left-arrow @click-right="searchShow = true">
        ...
        <van-list  v-model="loading"  :finished="finished" finished-text="没有更多了"   @load="onLoad"  :immediate-check="immediate" >
            <div   v-for="(item,index) in dataList" :key="index">
                <van-cell-group>
                    ...
                    <van-field label="瞬间流量:" v-model="item.instantaneousFlow" readonly :border="false"></van-field>
                    <van-field label="累计流量:" v-model="item.cumulativeFlow" readonly :border="false"></van-field>
                    <van-field label="总功耗:" v-model="item.kwh" readonly :border="false"></van-field>
                    <van-field label="工作效能:" v-model="item.efficacy" readonly :border="false"></van-field>
                    <van-field label="最大用水流量:" v-model="item.maxWater" readonly :border="false"></van-field>
                    <van-field label="最大用水时间:" v-model="item.maxWaterTm" readonly :border="false"></van-field>
