        ...
        data () {
            return {
                ...
                config: {
                    ...
                    canvasWidth:  window.screen.availWidth, //canvas宽高[Number] 可选
                    canvasHeight: window.screen.availHeight,  //高度[Number] 可选
        ...
        methods: {
            ...
            bindEvent () {
                ...
                this.canvas.addEventListener('touchstart', (e) => {
                    ...
                    //this.writeBegin({ x: touch.pageX || touch.clientX, y: touch.pageY - this.h || touch.clientY - this.h});
                    this.writeBegin({ x: touch.pageX , y: touch.clientY });
                });
                ...
                this.canvas.addEventListener('touchmove', (e) => {
                    e && e.preventDefault() && e.stopPropagation();
                    const touch = e.targetTouches[0];
                    //this.config.isWrite && this.writing({ x: touch.pageX, y: touch.pageY - this.h});
                    this.config.isWrite && this.writing({ x: touch.pageX, y: touch.clientY });
                });
                ...
                this.canvas.addEventListener('touchend', (e) => {
                    ...
                    //this.writeEnd({ x: touch.pageX, y: touch.pageY - this.h });
                    this.writeEnd({ x: touch.pageX, y: touch.clientY});
                });
                /* ==========================移动端兼容=End================================ */
            },
